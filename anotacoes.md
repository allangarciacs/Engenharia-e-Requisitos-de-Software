...
<pre>
  ...
  - Softwware de Sistema - Atender a outros programas (Sistema operacional)
  ...
  - Software de inteligêngia artificial - solucionar problemas complexos que não são possíveis de computação ou de 
  análise direta
...
## ENGENHARIA
<pre>
É a organização de um processo para a construção de um produto

- COMUNICAÇÃO   -> Características / Requisitos
  - PLANEJAMENTO  -> Custo / Tempo / *protótipo
    - PROJETO       -> U.M.l.                   = Qualidade -> Teste / Gerência 
      - CONSTRUÇÃO    -> Criando código                  
        - ENTREGA       -> Documentação / Manutenção    

Metodologia ou Ciclo de Vida -> Desenvolvimento de Software 
</pre>
